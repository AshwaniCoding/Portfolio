...
/**
 * AshwaniAvatar Component
 * Circular cartoon avatar logo matching the hero portrait character
 */
const AshwaniAvatar = ({ size = "w-8 h-8", className = "" }) => {
  return (
    <div className={`relative ${size} ${className} flex-shrink-0 select-none overflow-hidden rounded-full border border-zinc-300 dark:border-zinc-700 shadow-sm`}>
      <svg
        viewBox="0 0 512 512"
        fill="none"
      ...
      >
        <defs>
          <linearGradient id="navAvatarBg" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#1e1e24" />
            <stop offset="100%" stopColor="#09090b" />
          </linearGradient>

          <linearGradient id="navSkinBase" x1="0.5" y1="0" x2="0.5" y2="1">
            <stop offset="0%" stopColor="#eed0b6" />
            <stop offset="60%" stopColor="#e4bea0" />
            <stop offset="100%" stopColor="#d5aa8c" />
          </linearGradient>

          <linearGradient id="navSkinShadow" x1="0.5" y1="0" x2="0.5" y2="1">
            <stop offset="0%" stopColor="#cca082" stopOpacity="0.4" />
            <stop offset="100%" stopColor="#b38264" stopOpacity="0.8" />
          </linearGradient>

          <linearGradient id="navHairGrad" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#1e1e24" />
            <stop offset="40%" stopColor="#151518" />
            <stop offset="100%" stopColor="#0d0d0f" />
          </linearGradient>

          <linearGradient id="navMaroonShirt" x1="0.3" y1="0" x2="0.7" y2="1">
          ...
          <linearGradient id="navGlassesMetal" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#e2e8f0" />
            <stop offset="50%" stopColor="#94a3b8" />
            <stop offset="100%" stopColor="#cbd5e1" />
          </linearGradient>

          <linearGradient id="navLensReflect" x1="0" y1="0" x2="1" y2="1">
          ...
          <clipPath id="navAvatarCircle">
            <circle cx="256" cy="256" r="256" />
          </clipPath>
        </defs>

        {/* Background Circle */}
        <circle cx="256" cy="256" r="256" fill="url(#navAvatarBg)" />

        {/* Character Group */}
        <g clipPath="url(#navAvatarCircle)">
          <g transform="translate(256, 260) scale(1.15) translate(-260, -260)">
            {/* Shoulders & Torso */}
            <path
              d="M 60 580 C 70 480 130 430 200 415 L 260 445 L 320 415 C 390 430 450 480 460 580 Z"
              fill="url(#navMaroonShirt)"
            />
            <path d="M 248 450 L 272 450 L 274 580 L 246 580 Z" fill="#440b1b" />
            ...
            <path
              ...
              fill="url(#navSkinBase)"
            />
            <path
              d="M 215 310 C 240 375 280 375 305 310 L 305 345 C 280 380 240 380 215 345 Z"
              fill="url(#navSkinShadow)"
            />

            {/* Ears */}
            <path d="M 175 240 C 160 245 160 280 178 290 Z" fill="#e4bea0" stroke="#cca082" strokeWidth="1" />
            <path d="M 345 240 C 360 245 360 280 342 290 Z" fill="#e4bea0" stroke="#cca082" strokeWidth="1" />
            ...
            <path
              ...
              opacity="0.9"
            />
            <path d="M 230 325 C 240 352 280 352 290 325 C 285 342 235 342 230 325 Z" fill="#151518" />
            <path
            ...
            {/* Lips */}
            <path d="M 236 308 Q 260 318 284 308" stroke="#bd7f74" strokeWidth="3.5" strokeLinecap="round" />
            ...
            {/* Eyebrows */}
            <path d="M 206 218 Q 225 210 244 216" stroke="#1e1e24" strokeWidth="5" strokeLinecap="round" fill="none" />
            <path d="M 276 216 Q 295 210 314 218" stroke="#1e1e24" strokeWidth="5" strokeLinecap="round" fill="none" />
            ...
            <rect
              ...
              height="34"
              rx="7"
              fill="url(#navLensReflect)"
              stroke="url(#navGlassesMetal)"
              strokeWidth="2.5"
            />
            <rect
              x="270"
              ...
              strokeWidth="2.5"
            />
            <line x1="248" y1="222" x2="272" y2="222" stroke="url(#navGlassesMetal)" strokeWidth="2" strokeLinecap="round" />
            <line x1="250" y1="228" x2="270" y2="228" stroke="url(#navGlassesMetal)" strokeWidth="2" strokeLinecap="round" />
            <line x1="200" y1="224" x2="176" y2="242" stroke="url(#navGlassesMetal)" strokeWidth="2" strokeLinecap="round" />
            <line x1="320" y1="224" x2="344" y2="242" stroke="url(#navGlassesMetal)" strokeWidth="2" strokeLinecap="round" />

            {/* Hair */}
            <path
              d="M 174 195 C 165 140 210 65 260 60 C 310 65 355 140 346 195 C 342 165 320 145 260 145 C 200 145 178 165 174 195 Z"
              fill="url(#navHairGrad)"
            />
            <path
